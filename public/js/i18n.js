...
const UI_TEXT={
  fr:{
    ...
    monitorSoft:"Supervision non importante",
    ...
    proxmoxUrl:"URL Proxmox (ex. https://pve.example.com:8006)",
    ...
    statusSoftDown:"Indisponible (non critique)",
    statusPending:"Vérification en attente",
    statusNoResponse:"aucune réponse",
    widgetLabel:"Widget",
    widgetConfigTitle:"Configurer le widget",
    widgetStandard:"Standard",
    widgetDuplicati:"Duplicati",
    widgetDuplicatiPassword:"Mot de passe de l’API Duplicati",
    duplicatiPasswordPlaceholder:"Mot de passe",
    passwordConfigured:"mot de passe enregistré",
    widgetLichess:"Lichess",
    widgetLichessPlaceholder:"Pseudo Lichess",
    widgetLichessVariant:"Variante ELO",
    widgetLichessAuto:"Automatique (max)",
    widgetLichessClassical:"Classique",
    widgetLichessRapid:"Rapide",
    widgetLichessBlitz:"Blitz",
    widgetNoElo:"Aucun ELO enregistré",
    ...
    widgetDocker:"Docker",
    widgetDockerServer:"Serveur Docker",
    widgetDockerLocal:"Socket local (Dashmon)",
    widgetDockerTcp:"API Docker distante (TCP)",
    widgetDockerMode:"Connexion",
    widgetDockerUrl:"Adresse de l'API",
    widgetDockerUrlPlaceholder:"tcp://hôte:2375 ou https://…",
    widgetDockerHint:"Paramètres saisis à la main, sans serveur à créer. Socket local : le Docker du conteneur Dashmon (socket monté en lecture seule). TCP : adresse HTTP(S) d'une API Docker distante.",
    widgetDockerContainers:"Conteneurs",
    widgetDockerUpdated:"À jour",
    widgetDockerUnknown:"non vérifiés",
    noHostConfigured:"Aucun serveur Docker configuré",
    widgetConfigSaveLabel:"Valider",
    widgetOk:"Dernière sauvegarde OK",
    widgetNok:"Dernière sauvegarde en échec",
    widgetBadgeOk:"sauvegarde OK",
    widgetBadgeNok:"sauvegarde NOK",
    widgetNever:"Aucune sauvegarde enregistrée",
    widgetPending:"Vérification Duplicati…",
    widgetError:"Duplicati",
    ...
    faviconOptionOn:"Activée",
    faviconOptionOff:"Désactivée",
  ...
  en:{
    ...
    monitorSoft:"Non-critical monitoring",
    ...
    statusSoftDown:"Unavailable (non-critical)",
    statusPending:"Check pending",
    statusNoResponse:"no response",
    widgetLabel:"Widget",
    widgetConfigTitle:"Configure widget",
    widgetStandard:"Standard",
    widgetDuplicati:"Duplicati",
    widgetDuplicatiPassword:"Duplicati API password",
    duplicatiPasswordPlaceholder:"Password",
    passwordConfigured:"password saved",
    widgetLichess:"Lichess",
    widgetLichessPlaceholder:"Lichess username",
    widgetLichessVariant:"ELO variant",
    widgetLichessAuto:"Automatic (max)",
    widgetLichessClassical:"Classical",
    widgetLichessRapid:"Rapid",
    widgetLichessBlitz:"Blitz",
    widgetNoElo:"No ELO recorded yet",
    widgetAdGuard:"AdGuard",
    ...
    widgetAdGuardError:"AdGuard",
    widgetDocker:"Docker",
    widgetDockerServer:"Docker server",
    widgetDockerLocal:"Local socket (Dashmon)",
    widgetDockerTcp:"Remote Docker API (TCP)",
    widgetDockerMode:"Connection",
    widgetDockerUrl:"API address",
    widgetDockerUrlPlaceholder:"tcp://host:2375 or https://…",
    widgetDockerHint:"Parameters entered manually, no server to create. Local socket: the Docker of the Dashmon container (socket mounted read-only). TCP: HTTP(S) address of a remote Docker API.",
    widgetDockerContainers:"Containers",
    widgetDockerUpdated:"Updated",
    widgetDockerUnknown:"unverified",
    noHostConfigured:"No Docker server configured",
    widgetConfigSaveLabel:"Apply",
    widgetOk:"Last backup OK",
    widgetNok:"Last backup failed",
    widgetBadgeOk:"backup OK",
    widgetBadgeNok:"backup NOK",
    widgetNever:"No backup recorded yet",
    widgetPending:"Checking Duplicati…",
    widgetError:"Duplicati",
    viewRows:"Rows view",
    ...
    faviconFieldLabel:"Favicon (.ico)",
    faviconOptionOn:"Enabled",
    faviconOptionOff:"Disabled",
...
export function applyLanguage(){
  ...
  const appearanceLabels=[
    ...
    ["faviconOptionOn","faviconOptionOn"],
    ["faviconOptionOff","faviconOptionOff"],
