...
const UI_TEXT={
  fr:{
    ...
    close:"Fermer",
    search:"Rechercher une application, catégorie ou hôte...",
    ...
    bannerEnabledLabel:"Activer l’icône bannière",
    bannerUrlFieldLabel:"URL de la bannière",
    faviconFieldLabel:"Favicon (.ico)",
    faviconEnabledLabel:"Activer la favicon de l’onglet",
  ...
  en:{
    ...
    close:"Close",
    search:"Search an application, category or host...",
    ...
    bannerEnabledLabel:"Enable banner icon",
    bannerUrlFieldLabel:"Banner URL",
    faviconFieldLabel:"Favicon (.ico)",
    faviconEnabledLabel:"Enable tab favicon",
...
export function applyLanguage(){
  ...
  const appearanceLabels=[
    ...
    ["bannerEnabledLabel","bannerEnabledLabel"],
    ["bannerUrlFieldLabel","bannerUrlFieldLabel"],
    ["faviconFieldLabel","faviconFieldLabel"],
    ["faviconEnabledLabel","faviconEnabledLabel"],
