...
const UI_TEXT={
  fr:{
    ...
    widgetDockerLocal:"socket local",
    widgetDockerLocalTitle:"Docker via le socket du conteneur Dashmon (lecture seule)",
    widgetDockerHint:"Socket local : le Docker du conteneur Dashmon, prêt à l'emploi. Pour viser un Docker distant, ajoutez un hôte et son URL API TCP dans l'onglet Serveurs.",
  ...
  en:{
    ...
    widgetDockerLocal:"local socket",
    widgetDockerLocalTitle:"Docker via the Dashmon container socket (read-only)",
    widgetDockerHint:"Local socket : the Docker of the Dashmon container, ready to use. To target a remote Docker, add a host and its TCP API URL in the Servers tab.",
